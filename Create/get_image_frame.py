...
hands = mp_hands.Hands(min_detection_confidence=0.2, min_tracking_confidence=0.8, max_num_hands=1)
hands_ratio = mp_hands.Hands(min_detection_confidence=0.2, min_tracking_confidence=0.8, max_num_hands=1)

def get_image_frame(frame):
